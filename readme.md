...
- **Open source:** active contributor to AI inference & blockchain infrastructure — merged into [vLLM](https://github.com/vllm-project/vllm/pull/44942), [llguidance](https://github.com/guidance-ai/llguidance/pull/357), [Optimism](https://github.com/ethereum-optimism/optimism/pull/21127) and [mcp-go](https://github.com/mark3labs/mcp-go/pull/904), with further merged fixes in [Meilisearch](https://github.com/meilisearch/meilisearch/pull/6437), [revm](https://github.com/bluealloy/revm/pull/3735) and [celestia-node](https://github.com/celestiaorg/celestia-node/pull/5041)
